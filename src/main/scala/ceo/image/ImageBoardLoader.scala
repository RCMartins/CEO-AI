...
object ImageBoardLoader {
  ...
  def main(args: Array[String]): Unit = {
    ...
    new ImageBoardLoader(new File("PRINTS/challenge-2018-01-03.png"))
    //        new ImageBoardLoader(new File("PRINTS/challenge-2017-12-30.png"))
    //    new ImageBoardLoader(new File("PRINTS/print_test2.png"))
...
class ImageBoardLoader(imageIn: BufferedImage) {
  ...
  //  private  def getPieceFromBlack(row: Int, column: Int): PieceImage.PieceImageBlackOnly = {
